 ...
 */
@Data
public class TUserQuery extends BasePageQuery {
    @ApiModelProperty(value = "序号")
    @MyQuery(value = BaseQuery.eq,column = TUser.COL_ID)
    private Integer id;

    @ApiModelProperty(value = "编号")
    @MyQuery(value = BaseQuery.eq,column = TUser.COL_NO)
    private String no;

    @ApiModelProperty(value = "名称")
    @MyQuery(value = BaseQuery.eq,column = TUser.COL_NAME)
    private String name;

    @ApiModelProperty(value = "名称,模糊查询")
    @MyQuery(value = BaseQuery.like,column = TUser.COL_NAME)
